                ...
                <div class="table-responsive">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{__('general.Product')}}</th>
                                <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">{{__('general.Price')}}</th>
                                <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">{{__('general.Quantity')}}</th>
                                <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">{{__('general.Total')}}</th>
                                <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">{{__('general.Action')}}</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($items as $id => $item)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-500">Rp{{ number_format($item['price'], 0, ',', '.') }}</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-500">Rp{{ number_format($item['price'] * $item['quantity'], 0, ',', '.') }}</td>
